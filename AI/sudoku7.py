...
def setGlobals(pzl):
    global ALPHABET, SIZE, NBRLOOKUP, CONSTRAINTSETS, ITERLOOKUP
...
def getExhaustiveSet(pzl, dotsLeft, prevIndex):
    ...
    while True:
                ...
                for character in ALPHABET:
                    ...
                    for position in constraintSet:
                        if pzl[position] == character:
                            ...
                            numPossibilities -= candidates[character][position]
        ...
        # Applying the main choice! Todo: update the candidates table here
