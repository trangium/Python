...
def lazy_bp(weights, input_vals, target=[1, 0.25], alpha=0.1, epsilon=1e-6):
...
def smart_bp(weights, input_vals, target=[1, 0.25], alpha=0.1):
...
def randweights():
   ...
   layer4 = [random.uniform(-0.5, 0.5) for i in range(20*2)]
...
def main():
   ...
   for i in range(1000000):
      ...
      classifier = smart_bp(classifier, [x, y, 1], target=[res, 0.25*res], alpha=lr*0.4)
